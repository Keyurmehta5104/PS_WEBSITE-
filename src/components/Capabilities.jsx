        ...
        >
          {caps.map((cap) => (
            <motion.div
              ...
              className="bg-white border border-[#ececec] p-8 md:p-10 rounded-2xl flex flex-col justify-between h-[360px] relative overflow-hidden group transition-all duration-300 shadow-[0_16px_40px_-28px_rgba(20,20,30,0.25)] hover:border-[#5B3FA0] cursor-pointer"
            >
              {/* Card Top Label Row */}
              <div className="flex justify-between items-center z-10">
                ...
                <span className="text-xs bg-[#5B3FA0]/10 text-[#5B3FA0] px-2.5 py-1 rounded border border-[#5B3FA0]/25 font-bold uppercase tracking-wider">
                  {cap.tag}
                </span>
              </div>
              ...
              <div className="z-10 mt-6">
                <h3 className="text-xl md:text-2xl font-bold text-[#2b2b2b] mb-3 tracking-tight flex items-center gap-2 group-hover:text-[#5B3FA0] transition-colors">
                  {cap.title}
              ...
              <div className="border-t border-[#ececec] pt-6 mt-6 z-10 flex flex-col">
                <span className="text-[11px] font-bold tracking-wider text-[#5B3FA0] uppercase mb-1">Performance Metrics</span>
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#5B3FA0]/[0.06] rounded-full blur-[100px] pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </motion.div>
          ))}
        </motion.div>
